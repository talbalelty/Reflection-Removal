...
class VideoSeparation:
    ...
    def get_transmission(self):
        self.minimum_layer = self.process_video_separation(cv2.VideoCapture(self.path_to_stabilized_video),
                                                           self.extract_minimum_layer,
                                                           self.path_to_transmission_video)
        return cv2.VideoCapture(self.path_to_transmission_video)

    def get_reflection(self):
        self.maximum_layer = self.extract_maximum_layer(cv2.VideoCapture(self.path_to_stabilized_video),
                                                        self.minimum_layer, self.path_to_reflection_video)
    ...
    def process_video_separation(self, video, extraction_function, path):
    ...
    def extract_minimum_layer(self, frame_number, separated_video, window):
    ...
    def smooth(self, trajectory, smooth_amount):
    ...
    def stabilizeVideo(self):
        ...
        # Starting the stabilization process
